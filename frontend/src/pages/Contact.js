    ...
    <div className="contact-container">
      ...
      <div className="container">
        <div className="column">
          ...
          <p className="paragraph-text2"><b>Address</b><br></br>A-1802, Amrapali Sapphire, Sector-45, Noida</p>
          <div className="gap-div2"></div>
          <p className="paragraph-text2">+91-9911114128<br></br><a href="mailto:prachi_153@rediffmail.com" target='_blank' rel='noopener noreferrer'>prachi_153@rediffmail.com</a></p>
          <div className="gap-div2"></div>
          <p className="paragraph-text2"><b>Working Hours</b><br></br>Monday - Sunday:<br></br>10:00-22:00</p>
        ...
        <div className="column">
          ...
          <form>
              ...
              <div className="input-group">
                <textarea type="text" id="message" name="message" className="taller-input" required />
                <div className="required-indicator">(Required)</div>
              </div>
