...
const ProductPage = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[159.44rem] overflow-hidden text-center text-[1rem] text-black font-roboto">
      ...
      <div
        className="absolute top-[13.06rem] left-[2.5rem] tracking-[1.19px] leading-[1.28rem] uppercase font-medium cursor-pointer text-gray-900"
        onClick={onHomeCakesClick}
      >
        <span>{`Home / Cakes / `}</span>
        <span className="text-black">ChocoNilla</span>
      </div>
      ...
      <img
        className="absolute top-[101.13rem] left-[3.63rem] rounded-3xs w-[14.44rem] h-[15.06rem] object-cover"
        alt=""
        src="/image@2x.png"
      />
      <img
        className="absolute top-[101.13rem] left-[39.19rem] rounded-3xs w-[14.44rem] h-[15.06rem] object-cover cursor-pointer"
        alt=""
        src="/image1@2x.png"
      ...
      <img
        ...
        src="/image3@2x.png"
      />
      <div className="absolute top-[120.5rem] left-[6.38rem] rounded-3xs bg-gold-200 w-[8.94rem] h-[2.88rem]" />
      ...
      <div
        className="absolute top-[120.5rem] left-[41.94rem] rounded-3xs bg-gold-200 w-[8.94rem] h-[2.88rem] cursor-pointer"
      ...
      <img
        ...
        src="/vector3.svg"
      />
      <div className="absolute top-[35.63rem] left-[38.13rem] box-border w-[34.38rem] h-[10.88rem] border-[0.5px] border-solid border-gray-300" />
      <img
        className="absolute top-[37.06rem] left-[70.31rem] w-[0.94rem] h-[0.94rem]"
        alt=""
        src="/.svg"
      />
      <img
        className="absolute top-[40.63rem] left-[70.31rem] w-[0.94rem] h-[0.94rem]"
        alt=""
        src="/.svg"
      />
      <img
        className="absolute top-[44.19rem] left-[70.31rem] w-[0.94rem] h-[0.94rem]"
        alt=""
        src="/.svg"
      />
      <div className="absolute top-[36.44rem] left-[38.31rem] flex flex-row items-start justify-start p-[0.63rem] text-left font-h2-petite">
        <div className="relative">ALLERGENTS</div>
      </div>
      <div className="absolute top-[40.63rem] left-[38.94rem] font-h2-petite text-left">
        INGREDIENTS
      </div>
      <div className="absolute top-[44.19rem] left-[38.94rem] font-h2-petite text-left">
        SIZE
      </div>
      <div className="absolute top-[39.36rem] left-[38.11rem] box-border w-[34.22rem] h-[0.03rem] border-t-[0.5px] border-solid border-gray-300" />
      <div className="absolute top-[42.92rem] left-[38.11rem] box-border w-[34.22rem] h-[0.03rem] border-t-[0.5px] border-solid border-gray-300" />
      <img
